				...
				<section class="panel">
					...
					<div class="panel-body">
	                      <div class="form-group">
	                          ...
	                          <div class="col-sm-10">
	                          	<img src="<#if article.picture??>${BASE_PATH}/${article.picture}</#if>" alt="img04" style="height:120px;">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <input type="text" data-link-format="yyyy-mm-dd" data-date-format="yyyy-MM-dd" style="font-size:15px;" class="js_create_time" name="updateTime"
                              	placeholder="发布时间" id="updateTime" value="<#if article.updateTime??>${article.updateTime?string("yyyy-MM-dd")}<#elseif article.createTime??>${article.createTime?string("yyyy-MM-dd")}</#if>" readonly>
                              </input>
                          </div>
                        </div>    
                        <div class="form-group">
...
$(function(){
	...
	$('#file_upload').uploadify({
		'buttonText'  		: 	'请选择文件',
        'swf'         		: 	'${BASE_PATH}/static/template/manage/assets/uploadify/uploadify.swf',
