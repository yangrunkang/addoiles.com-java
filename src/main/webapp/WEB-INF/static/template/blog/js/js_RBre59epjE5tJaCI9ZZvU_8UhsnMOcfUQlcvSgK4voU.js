(function ($) {  
  ...
  Drupal.behaviors.tl_general = {

    attach: function (context, settings) {

        $(".dropdown-notification").addClass('inactive-dropdown');

        $("#notifications_dropdown").click(function (){

            if ($(".dropdown-notification").hasClass('inactive-dropdown')) {
                $(".dropdown-notification").removeClass('inactive-dropdown');
                $(".dropdown-notification").addClass('active-dropdown');
            } else {

                $(".dropdown-notification").removeClass('active-dropdown');
                $(".dropdown-notification").addClass('inactive-dropdown');
        ...
        $('body').click(function (event){
            ...
            if (!$(event.target).is('.dropdown-notification') && !$(event.target).is('#notifications_dropdown') && $('.dropdown-notification').hasClass('active-dropdown')) {
