...
public class ConfigManageAction extends BaseManageAction{
	...
	public JsonVo<String> update(@RequestParam(value="webId")long webId,
		...
		JsonVo<String> json = new JsonVo<String>();
			try {
				...
				if(configService.getIntKey("shamrock_webId")!=webId){
	...
	public String edit(@RequestParam(value="folderId")long folderId,ModelMap modelMap,HttpServletRequest request){
	...
	public JsonVo<String> edit(@RequestParam("folderId")long folderId,
		...
		try {
			...
			if (logo != null && !logo.isEmpty()) {
				logo_image = MediaUtils.saveImage(logo, folder.getWidth(),
						folder.getHeight());
			}
			folder.setLogo(logo_image);
